      ...
      <View style={styles.noticeTop}>
        ...
        <View style={{ flex: 1 }}>
          <View style={styles.noticeTitleRow}>
            <Text
              style={[styles.noticeTitle, { color: textColor }]}
              numberOfLines={2}
            >
              {notice.title}
            </Text>
            {notice.isPinned && (
              ...
              >
                ...
                <Text style={[styles.pinnedText, { color: cfg.color }]}>
                  PINNED
                </Text>
              </View>
            )}
        ...
        <TouchableOpacity
          ...
          style={[styles.delBtn, { borderColor: "#FEE2E2" }]}
        >
          <Feather name="trash-2" size={13} color="#EF4444" />
        </TouchableOpacity>
      </View>
      <Text
        style={[styles.noticeContent, { color: muted }]}
...
export default function AdminNoticeBoard() {
  ...
  const visible =
    activeFilter === "ALL"
      ? notices
      : notices.filter(
          (n) => (n.category || "GENERAL").toUpperCase() === activeFilter,
        );
    ...
    <View style={[styles.container, { backgroundColor: bg }]}>
            ...
            return (
              ...
              >
                <Feather
                  name={f.icon}
                  size={11}
                  color={active ? (cfg ? cfg.color : tint) : muted}
                />
                <Text
                  style={[
      ...
      >
        <View style={styles.content}>
          ...
          >
            <View
              style={[styles.summaryIconWrap, { backgroundColor: tint + "15" }]}
            >
          ...
          <View style={styles.sectionRow}>
            ...
            >
              ...
              <Text style={[styles.sectionTitle, { color: textColor }]}>
                {activeFilter === "ALL"
                  ? "All Notices"
                  : getCat(activeFilter).label + " Notices"}
              </Text>
            </View>
          </View>
          ...
          {visible.length === 0 ? (
            ...
            >
              ...
              <Text style={[styles.emptyDesc, { color: muted }]}>
                {activeFilter === "ALL"
                  ? "Post your first notice to inform admins."
                  : `No ${getCat(activeFilter).label.toLowerCase()} notices found.`}
              </Text>
              {activeFilter === "ALL" && (
                <TouchableOpacity
