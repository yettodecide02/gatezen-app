...
export default function StaffManagement() {
  ...
  const stats = [
    ...
    {
      label: "On Duty",
      value: gatekeepers.filter((g) => g.onDuty).length,
      icon: "clock",
      color: "#3B82F6",
    },
  ];
        ...
        <View style={styles.headerLeft}>
          ...
          <View>
            ...
            <Text style={[styles.screenSub, { color: muted }]}>
              {gatekeepers.length} gatekeepers
            </Text>
          </View>
        </View>
        <TouchableOpacity
            ...
            return (
              ...
              >
                <View style={styles.staffRow}>
                  <View
                    style={[styles.avatar, { backgroundColor: "#6366F11A" }]}
                  >
                  ...
                  <View style={styles.staffInfo}>
                    ...
                    <Text style={[styles.staffEmail, { color: muted }]}>
                      {g.email}
                    </Text>
                  </View>
                ...
                <View
                  style={[styles.staffDivider, { backgroundColor: borderCol }]}
                />
                <View style={styles.staffMeta}>
                  ...
                  <TouchableOpacity
                    onPress={() => setDeleteConfirmId(g.id)}
