...
function getOverstayCount(visitors) {
  return visitors.filter((v) => {
    ...
    const mins = Math.floor(
      (Date.now() - new Date(v.checkInAt).getTime()) / 60000,
    );
    const limit =
      OVERSTAY_LIMITS[v.visitorType?.toUpperCase()] ?? OVERSTAY_LIMITS.OTHER;
    return mins > limit;
  }).length;
}
...
function getStatusConfig(checkIn, checkOut) {
  if (!checkIn)
    return { bg: "#F3F4F6", text: "#374151", label: "Pending", icon: "clock" };
  if (checkIn && !checkOut)
    return {
      bg: "#D1FAE5",
      text: "#065F46",
...
export default function VisitorLog() {
  ...
  const uniqueUnits = [
    ...new Set(visitors.map((v) => v.user?.unit?.number).filter(Boolean)),
  ];
  ...
  const filteredVisitors = visitors.filter((v) => {
    ...
    const matchSearch =
      ...
      v.user?.unit?.number?.toLowerCase().includes(s);
    const matchType = typeFilter === "ALL" || v.visitorType === typeFilter;
    const matchUnit =
      unitFilter === "ALL" || v.user?.unit?.number === unitFilter;
      ...
      >
        ...
        <TouchableOpacity
          ...
          style={[
            ...
            {
              backgroundColor:
                overstayCount > 0 ? "#EF4444" : isDark ? "#2C2C2E" : "#F1F5F9",
        ...
        >
          ...
          {overstayCount > 0 && <View style={styles.overstayDot} />}
        </TouchableOpacity>
      </View>
        ...
        <View style={styles.content}>
          ...
          {overstayCount > 0 && (
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <Text
                  style={[styles.overstayBannerTitle, { color: "#F59E0B" }]}
                >
            ...
            >
              ...
              >
                ...
                {(searchTerm ||
                  ...
                  unitFilter !== "ALL") && (
                  <View
                    style={[styles.filterActiveDot, { backgroundColor: tint }]}
                  />
                )}
              </View>
              <Feather
            ...
            {filtersExpanded && (
              <View style={{ gap: 14, marginTop: 4 }}>
                <View>
                  ...
                  <View style={styles.searchWrap}>
                    ...
                    <TextInput
                      ...
                      placeholder="Name, contact, vehicle..."
                ...
                {Platform.OS === "ios" && showDatePicker && (
                  <TouchableOpacity
                    style={[styles.iosDoneBtn, { backgroundColor: tint }]}
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    >
                      ...
                      >
                        ...
                        {uniqueUnits.map((u) => (
                          <Picker.Item key={u} label={`Unit ${u}`} value={u} />
                        ))}
                      </Picker>
                    </View>
                  </View>
              ...
              {filteredVisitors.map((visitor) => {
                ...
                const visitorMins =
                  visitor.checkInAt && !visitor.checkOutAt
                    ? Math.floor(
                        (Date.now() - new Date(visitor.checkInAt).getTime()) /
                          60000,
                      )
                    : 0;
                const visitorLimit =
                  OVERSTAY_LIMITS[visitor.visitorType?.toUpperCase()] ??
                  OVERSTAY_LIMITS.OTHER;
                  ...
                  >
                    ...
                    {isOver && (
                      ...
                      >
                        ...
                        <Text style={styles.overstayRowText}>
                          Overstaying by{" "}
                          {Math.floor(visitorMins - visitorLimit)} min
                    ...
                    <View style={styles.vCardTop}>
                      ...
                      <View style={styles.vCardInfo}>
                        <Text style={[styles.vName, { color: textColor }]}>
                          {visitor.name}
                        </Text>
                        <View
                          style={[
                    ...
                    <View style={styles.vDetails}>
                      <View style={styles.vDetailItem}>
                        ...
                        <Text style={[styles.vDetailText, { color: muted }]}>
                    ...
                    {/* Check-in/out times */}
                    <View
                      style={[styles.vTimes, { borderTopColor: borderCol }]}
                    >
                      ...
                      <View style={styles.vTimeItem}>
                        <View
                          style={[
                            styles.vTimeIcon,
                            {
                              backgroundColor: visitor.checkOutAt
                                ? "#E5E7EB"
                                : borderCol,
                            },
                          ]}
