...
export default function ForgotPasswordScreen() {
  ...
  const STEP_META = {
    email: {
      ...
      hint: "Enter the email linked to your account and we'll send a verification code.",
      btnLabel: "Send verification code",
      btnLoadingLabel: "Sending…",
    },
    otp: {
      icon: "hash" as const,
      heading: "Enter verification code",
      hint: `We sent a 6-digit code to ${email || "your email"}. Check your inbox.`,
      btnLabel: "Verify code",
      btnLoadingLabel: "Verifying…",
    },
    reset: {
      icon: "lock" as const,
      heading: "Set new password",
      hint: "Choose a strong password you haven't used before.",
      btnLabel: "Reset password",
      btnLoadingLabel: "Resetting…",
    },
  };
  ...
  return (
    <View
      style={[styles.safeArea, { backgroundColor: bg, paddingTop: insets.top }]}
    >
      <KeyboardAvoidingView
        style={{ flex: 1 }}
        ...
        >
          ...
          >
              ...
              {STEPS.map((s, i) => (
                <View
                  ...
                  style={[
                    ...
                    {
                      backgroundColor:
                        i <= stepIndex ? tint : isDark ? "#333" : "#E5E7EB",
            ...
            <View style={styles.form}>
              ...
              <LoadingButton
                label={meta.btnLabel}
                loadingLabel={meta.btnLoadingLabel}
                loading={loading}
                bgColor={tint}
              ...
              {stage !== "email" && (
                <LoadingButton
                  ...
                  size="sm"
                  fullWidth={false}
                  onPress={() => setStage(stage === "reset" ? "otp" : "email")}
