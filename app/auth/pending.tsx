    ...
    >
      ...
      >
        ...
        {checkResult === "still_pending" && (
          ...
          >
            ...
            <Text style={styles.warningText}>
              Still pending — contact your community admin.
            </Text>
          </View>
        )}
          ...
          {[
            ...
            <View key={i} style={styles.stepRow}>
              <View style={[styles.stepNum, { backgroundColor: tint + "1A" }]}>
                <Text style={[styles.stepNumText, { color: tint }]}>
                  {i + 1}
                </Text>
              </View>
        ...
        <TouchableOpacity
          ...
          style={[
            styles.btn,
            { backgroundColor: checking ? tint + "80" : tint },
          ]}
        >
          {checking ? (
            <ActivityIndicator size="small" color={btnTextColor} />
          ) : (
            <Feather name="refresh-cw" size={16} color={btnTextColor} />
          )}
