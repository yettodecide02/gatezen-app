...
export default function RegisterScreen() {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        if (res.data.data.length === 0)
          showError("No communities available. Contact administrator.");
  ...
  const validate = () => {
    ...
    if (!selectedCommunity) {
      setCommunityErr("Please select your community");
      ok = false;
    } else setCommunityErr("");
    if (!password) {
  ...
  const DropdownField = ({
    ...
    <View style={styles.fieldGroup}>
      ...
      >
        ...
        <Text
          style={[styles.dropdownText, { color: value ? textColor : muted }]}
          numberOfLines={1}
        >
      ...
      <View style={styles.modalOverlay}>
        ...
        >
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                style={[styles.modalItem, { borderBottomColor: borderCol }]}
            ...
            ListEmptyComponent={() => (
              <View style={styles.modalEmpty}>
                <Text style={[styles.modalEmptyText, { color: muted }]}>
    ...
    >
          ...
          <View style={styles.form}>
            ...
            <DropdownField
              ...
              onPress={() => {
                ...
                if (communityErr) setCommunityErr("");
              }}
      ...
      <SelectModal
        ...
        onSelect={(item) => {
          ...
          setSelectedBlockName(item.name);
      ...
      <SelectModal
        ...
        onSelect={(item) => {
          ...
          setSelectedUnitName(item.number);
