  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: text }]}>Meter Reading</Text>
      </View>
      ...
      <View style={styles.container}>
        ...
        <Text style={[styles.title, { color: text }]}>Utility Meters</Text>
        <Text style={[styles.subtitle, { color: text, opacity: 0.7 }]}>
          View meter readings and utility bills
        </Text>
