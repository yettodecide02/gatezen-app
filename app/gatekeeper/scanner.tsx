      ...
      try {
        ...
        showError(
          e?.response?.data?.error ||
            ...
            "Visitor not found or QR invalid",
        );
        resetScan();
      } finally {
        setLoading(false);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#000" }}>
      ...
      >
        {/* Overlay */}
        <View
          pointerEvents={visitor ? "none" : "auto"}
          style={{
            flex: 1,
        ...
        >
          ...
          <Text
            style={{ color: "#fff", fontSize: 13, marginTop: 16, opacity: 0.8 }}
          >
            {loading
              ? "Looking up visitor…"
              : scanning
          ...
          >
            ...
            <Pressable
              onPress={() => router.push("/gatekeeper/vehicle-search")}
              style={({ pressed }) => ({
                flexDirection: "row",
                alignItems: "center",
                gap: 7,
            ...
            {visitor.unit && (
              ...
              >
                ...
                <Text style={{ fontSize: 12, color: muted }}>
                  ...
                  {visitor.block
                    ? `· Block ${visitor.block?.name || visitor.block}`
                    : ""}
                </Text>
              </View>
            )}
