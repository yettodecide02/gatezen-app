...
function getVehicleIcon(type) {
  ...
  if (t === "BIKE")
    return { icon: "wind", color: "#10B981", bg: "#D1FAE5", darkBg: "#002A1A" };
  if (t === "SCOOTER")
    return { icon: "zap", color: "#F59E0B", bg: "#FEF3C7", darkBg: "#2D1A00" };
  if (t === "AUTO")
    return {
      icon: "navigation",
      color: "#8B5CF6",
      ...
      <View style={styles.resultTop}>
        <View
          style={[
            ...
            { backgroundColor: isDark ? vc.darkBg : vc.bg },
          ]}
        >
            ...
            {result.vehicleColor && (
              ...
              >
                <View
                  style={[
                    styles.colorDot,
                    { backgroundColor: result.vehicleColor },
                  ]}
                />
                <Text style={[styles.colorPillText, { color: muted }]}>
                  {result.vehicleColor}
                </Text>
              </View>
            )}
      ...
      <View style={styles.detailsGrid}>
        ...
        <View style={styles.detailItem}>
          <View
            style={[
              styles.detailIcon,
              { backgroundColor: isDark ? "#1C2A1A" : "#D1FAE5" },
            ]}
          >
        ...
        {result.contact && (
          <View style={styles.detailItem}>
            <View
              style={[
                styles.detailIcon,
                { backgroundColor: isDark ? "#2D1A00" : "#FEF3C7" },
              ]}
            >
      ...
      {result.registeredAt && (
        <View style={[styles.resultFooter, { borderTopColor: borderCol }]}>
          ...
          <Text style={[styles.resultFooterText, { color: muted }]}>
            Registered{" "}
            {new Date(result.registeredAt).toLocaleDateString("en-IN", {
              day: "2-digit",
              month: "short",
              year: "numeric",
            })}
  ...
  const handleSearch = useCallback(
    async (searchQuery = query) => {
      ...
      try {
        ...
        const data =
          res.data?.vehicles || res.data?.results || res.data?.data || [];
    ...
    <View style={{ flex: 1, backgroundColor: pageBg }}>
      ...
      <View
        style={[
          ...
          { backgroundColor: pageBg, borderBottomColor: borderCol },
        ]}
      >
        <View
          style={[
        ...
        >
          {loading ? (
            ...
            <Feather
              name="search"
              size={18}
              color={query.trim().length >= 2 ? "#fff" : muted}
            />
          )}
        </TouchableOpacity>
      </View>
          ...
          <>
            ...
            {recent.length > 0 && (
              ...
              >
                <View style={styles.recentHeader}>
                  ...
                  <Text style={[styles.recentTitle, { color: muted }]}>
                    RECENT SEARCHES
                  </Text>
                </View>
                <View style={styles.recentChips}>
                  {recent.map((r) => (
                    ...
                    >
                      ...
                      <Text
                        style={[styles.recentChipText, { color: textColor }]}
                      >
                        {r}
                      </Text>
                    </TouchableOpacity>
            ...
            >
              ...
              {[
                ...
                {
                  icon: "search",
                  tip: "Partial search works — try 'MH12' or 'AB12'",
                },
                {
                  icon: "user",
                  tip: "Results show owner name, flat, block & contact",
                },
              ].map(({ icon, tip }) => (
            ...
            >
              <Text style={[styles.examplesTitle, { color: muted }]}>
                EXAMPLE FORMATS
              </Text>
              <View style={styles.examplesRow}>
                {["MH12AB1234", "KA05CD5678", "DL3CAF9999", "TN22EF0011"].map(
                  (ex) => (
                    <TouchableOpacity
                      key={ex}
                      onPress={() => {
                    ...
                    >
                      <Text
                        style={[styles.exampleChipText, { color: textColor }]}
                      >
                        {ex}
                      </Text>
                    </TouchableOpacity>
        ...
        {loading && (
          <View style={styles.loadingWrap}>
            ...
            >
              ...
              <Text style={[styles.loadingSubText, { color: muted }]}>
                Looking for "{query}"
              </Text>
            </View>
          </View>
        ...
        {searched && !loading && results.length === 0 && (
          ...
          >
            ...
            >
              ...
              <Text style={[styles.tryAgainText, { color: tint }]}>
                Try another number
              </Text>
            </TouchableOpacity>
          </View>
        ...
        {!loading && results.length > 0 && (
          <>
            ...
            <View style={styles.resultsHeader}>
              ...
              <Text style={[styles.resultsForText, { color: muted }]}>
                for "{query}"
              </Text>
              <View style={{ flex: 1 }} />
