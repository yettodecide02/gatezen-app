...
export default function GatekeeperVisitors() {
  ...
  const TABS = [
    ...
    ...(enabledFeatures.includes("KIDS_CHECKOUT")
          ...
          {TABS.map((t) => (
            <Pressable
              ...
              style={{
                ...
                paddingBottom: 10,
                borderBottomWidth: 2,
                borderBottomColor: activeTab === t.key ? tint : "transparent",
              }}
            >
              <View
              ...
              >
                <Text
                  style={{
                    fontSize: 13,
                    fontWeight: "600",
                    color: activeTab === t.key ? tint : muted,
                  }}
                >
                  {t.label}
                </Text>
                <View
                  style={{
                    ...
                    borderRadius: 10,
                    backgroundColor:
                      activeTab === t.key ? tint + "20" : borderCol,
                  }}
                >
                  <Text
                    style={{
                ...
                return (
                  ...
                  >
                    ...
                    {isPending && (
                      ...
                      >
                        <Pressable
                          onPress={() => updateVisitor(v.id, "cancelled")}
                        ...
                        <Pressable
                          onPress={() => updateVisitor(v.id, "checked_in")}
                          disabled={updating === v.id}
                          style={{
                            flex: 2,
                            paddingVertical: 8,
                    ...
                    {key === "checked_in" && (
                      <Pressable
                        onPress={() => updateVisitor(v.id, "checked_out")}
                        disabled={updating === v.id}
                        style={{
                          marginTop: 10,
                          paddingVertical: 8,
                  ...
                  {(isPending || isIn) && (
                    ...
                    >
                      {isPending && (
                        <>
                          <Pressable
                            onPress={() => updateKidPass(p.id, "REJECTED")}
                          ...
                          <Pressable
                            onPress={() => updateKidPass(p.id, "CHECKED_IN")}
                            disabled={updating === p.id}
                            style={{
                              flex: 2,
                              paddingVertical: 8,
                      ...
                      {isIn && (
                        <Pressable
                          onPress={() => updateKidPass(p.id, "CHECKED_OUT")}
                          disabled={updating === p.id}
                          style={{
                            flex: 1,
                            paddingVertical: 8,
