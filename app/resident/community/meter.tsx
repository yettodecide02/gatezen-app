  ...
  return (
    <View style={{ flex: 1, backgroundColor: bg }}>
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", padding: 32, gap: 16 }}>
        ...
        <Text style={{ fontSize: 22, fontWeight: "700", color: text, textAlign: "center" }}>Meter Readings</Text>
        ...
        <Text style={{ fontSize: 14, color: muted, textAlign: "center", lineHeight: 20 }}>Submit and track utility meter readings online. Available soon.</Text>
      </View>
    </View>
  );
}
