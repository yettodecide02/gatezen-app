  ...
  return (
    ...
    >
      ...
      <View style={[styles.resAvatar, { backgroundColor: color + "20" }]}>
        <Text style={[styles.resAvatarText, { color }]}>
...
export default function Directory() {
  ...
  const blocks = useMemo(() => {
    const s = new Set(
      residents.map((r) => r.blockName || r.block?.name).filter(Boolean),
    );
    ...
    <View style={[styles.container, { backgroundColor: bg }]}>
      ...
      >
        <View
          style={[
            styles.searchBar,
            { backgroundColor: fieldBg, borderColor: query ? tint : borderCol },
          ]}
        >
            ...
            groups.map(([letter, list]) => (
              <View key={letter} style={{ marginBottom: 8 }}>
                ...
                <View style={styles.sectionHeader}>
                  <Text style={[styles.sectionLetter, { color: tint }]}>
                    {letter}
                  </Text>
                  <View
                    style={[styles.sectionLine, { backgroundColor: borderCol }]}
                  />
