  ...
  return (
    <View style={{ flex: 1, backgroundColor: bg }}>
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", padding: 32, gap: 16 }}>
        <View style={{ width: 72, height: 72, borderRadius: 36, backgroundColor: "#06B6D418", alignItems: "center", justifyContent: "center" }}>
          <Feather name="headphones" size={32} color="#06B6D4" />
        </View>
        <Text style={{ fontSize: 22, fontWeight: "700", color: text, textAlign: "center" }}>Contact Support</Text>
        ...
        <Text style={{ fontSize: 14, color: muted, textAlign: "center", lineHeight: 20 }}>Reach our support team for assistance. Coming soon.</Text>
      </View>
    </View>
  );
}
