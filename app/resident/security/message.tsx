  ...
  return (
    <View style={{ flex: 1, backgroundColor: bg }}>
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", padding: 32, gap: 16 }}>
        <View style={{ width: 72, height: 72, borderRadius: 36, backgroundColor: "#8B5CF618", alignItems: "center", justifyContent: "center" }}>
          <Feather name="message-square" size={32} color="#8B5CF6" />
        </View>
        <Text style={{ fontSize: 22, fontWeight: "700", color: text, textAlign: "center" }}>Security Message</Text>
        ...
        <Text style={{ fontSize: 14, color: muted, textAlign: "center", lineHeight: 20 }}>Send a message to security quickly. Feature coming soon.</Text>
      </View>
    </View>
  );
}
