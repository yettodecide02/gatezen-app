    ...
    >
      ...
      <View style={styles.surveyBody}>
        ...
        <View style={[styles.statsRow, { borderColor: borderCol }]}>
          ...
          <View style={styles.statItem}>
            <Text
              style={[styles.statValue, { color: done ? "#10B981" : muted }]}
            >
              {done ? "✓" : "—"}
            </Text>
            <Text style={[styles.statLabel, { color: muted }]}>
              {done ? "Responded" : "Your Status"}
            </Text>
          </View>
        </View>
      ...
      <View style={styles.modalOverlay}>
        <View style={[styles.sheet, { backgroundColor: sheetBg }]}>
          ...
          <View
            style={[
              styles.progressBg,
              { backgroundColor: isDark ? "#252525" : "#E2E8F0" },
            ]}
          >
            <View
              style={[
                styles.progressFill,
                { backgroundColor: tint, width: `${progress}%` },
              ]}
            />
          </View>
          ...
          {current && (
            ...
            >
              ...
              {/* MULTIPLE_CHOICE */}
              {(current.type === "MULTIPLE_CHOICE" || !current.type) &&
                    ...
                    >
                      <View
                        style={[
                          styles.radio,
                          {
                            borderColor: sel ? tint : muted,
                            backgroundColor: sel ? tint : "transparent",
                          },
                        ]}
                      >
