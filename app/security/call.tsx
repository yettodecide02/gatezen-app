...
export default function SecurityCall() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: bg }}>
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", padding: 32, gap: 16 }}>
        <View style={{ width: 72, height: 72, borderRadius: 36, backgroundColor: "#3B82F618", alignItems: "center", justifyContent: "center" }}>
          <Feather name="phone" size={32} color="#3B82F6" />
        </View>
        <Text style={{ fontSize: 22, fontWeight: "700", color: text, textAlign: "center" }}>Security Call</Text>
        ...
        <Text style={{ fontSize: 14, color: muted, textAlign: "center", lineHeight: 20 }}>Direct line to security guard on duty. Feature coming soon.</Text>
      </View>
    </View>
  );
}
